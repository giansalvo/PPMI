...
def main():
    ...
    d_train = d_train.drop("Embarked", axis=1)
    d_train = d_train.drop("Sex", axis=1)
    d_train = d_train.drop("Ticket", axis=1)
    print("features:", d_train.columns.to_list())
    print(d_train.head())
    ...
    d_test = d_test.drop("Embarked", axis=1)
    d_test = d_test.drop("Sex", axis=1)
    d_test = d_test.drop("Ticket", axis=1)
    print("features:", d_test.columns.to_list())
    print(d_test.head())
    ...
    ##############################################################
    X_names = ["Age", "Fare", "SibSp", "Pclass", "Parch"]
